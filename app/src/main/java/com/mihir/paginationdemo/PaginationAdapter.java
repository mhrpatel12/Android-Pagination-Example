...
public class PaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        UserList videoPost = listVideoPosts.get(position); // UserList

        switch (getItemViewType(position)) {

            case ITEM:
                final VideoPostVH videoPostVH = (VideoPostVH) holder;

                videoPostVH.txtFirstName.setText(videoPost.getFirstName());
                videoPostVH.txtLastName.setText(videoPost.getLastName());

                loadImage(videoPost.getAvatarImageURL())
                        .listener(new RequestListener<String, GlideDrawable>() {
                            @Override
                            public boolean onException(Exception e, String model, Target<GlideDrawable> target, boolean isFirstResource) {
                                videoPostVH.mProgress.setVisibility(View.GONE);
                                return false;
                            }
